...
const get_dates_filter_dto_1 = require("./dto/get-dates.filter.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: "Get all dates of user" }),
    ...
    __metadata("design:paramtypes", [get_dates_filter_dto_1.GetDatesFilterDto]),
    __metadata("design:returntype", Promise)
], DateController.prototype, "getUser", null);
DateController = __decorate([
    (0, swagger_1.ApiTags)("Dates"),
    (0, common_1.Controller)("dates"),
    __metadata("design:paramtypes", [dates_service_1.DateService])
], DateController);
